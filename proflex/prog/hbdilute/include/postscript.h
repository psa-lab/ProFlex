...
void print_current_Hbond_info_landscape_multipage(
    FILE *, int, int, int, int *, int, float, int, int[], int, int, int, float,
    int *, int, int, int, int[], char[], char[], FILE *[], int, int, char, char,
    char[], char[], int[], float,
    /* SN 2008:01 */ int, int, char, char, int);
void print_decomp(clusters *[], int, int, FILE *, int[], int[], int, int, int[],
                  char[], int, int[], int[], char[],
                  /* SN 2008:01*/ int[][2], int[], int[]);
void print_multipage_decomp(clusters *[], int, int, FILE *, int[], int[], int,
                            FILE *[], int, int, int[], char[], int, int[],
                            int[], char[],
                            /* SN 2008:01*/ int[][2], int[], int[]);
